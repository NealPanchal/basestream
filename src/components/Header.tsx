...
/**
 * Header.tsx — Premium BaseStream Navigation Bar
 *
          ...
          <div className="flex items-center justify-between h-[68px]">
            ...
            <div className="flex items-center gap-8 xl:gap-10">
              ...
              >
                ...
                >
                  {/* glow ring */}
                  <div className="absolute inset-0 rounded-xl bg-base-blue/30 blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 scale-110" />
                  <div className="relative flex items-center justify-center w-9 h-9 rounded-xl bg-base-blue shadow-lg shadow-base-blue/30">
                    <Logo size={20} color="#ffffff" />
                  </div>
                </motion.div>

                <div className="hidden sm:flex flex-col leading-none">
                  <span className="text-white font-extrabold text-[17px] tracking-[-0.03em] group-hover:text-base-blue transition-colors duration-200">
                    Base<span className="text-base-blue group-hover:text-white transition-colors duration-200">Stream</span>
                  </span>
            ...
            <div className="flex items-center gap-1 sm:gap-2">
              ...
              >
                ...
                {hasNotification && (
                  <motion.span
                    className="absolute top-1.5 right-1.5 w-[7px] h-[7px] bg-base-blue rounded-full"
              ...
              {isConnected && address ? (
                          ...
                          <div className="px-4 py-3 border-b border-white/[0.06]">
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-[13px] text-gray-300 font-medium">Base Network</span>
                              </div>
                ...
                <motion.button
                  ...
                  className="flex items-center gap-2 h-9 px-4 rounded-full bg-base-blue hover:bg-base-blue-hover text-white text-[13px] font-semibold shadow-lg shadow-base-blue/25 hover:shadow-base-blue/40 transition-all duration-200"
            ...
            >
              ...
              <div className="flex items-center justify-between px-6 py-5 border-b border-white/[0.06]">
                <div className="flex items-center gap-2.5">
                  <div className="flex items-center justify-center w-8 h-8 rounded-xl bg-base-blue shadow-lg shadow-base-blue/30">
                    <Logo size={16} color="#ffffff" />
                  </div>
                  <span className="font-extrabold text-white text-base tracking-tight">
                    Base<span className="text-base-blue">Stream</span>
                  </span>
                </div>
                <button
                  onClick={() => setIsMobileOpen(false)}
              ...
              <div className="px-4 py-5 border-t border-white/[0.06]">
                {isConnected && address ? (
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between px-3 py-2">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-gray-400 text-xs">Base Network</span>
                      </div>
                      <div className="flex items-center gap-1.5">
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2.5 py-3.5 bg-base-blue hover:bg-base-blue-hover text-white font-semibold rounded-xl shadow-lg shadow-base-blue/25 transition-all duration-200 text-[14px]"
                  >
                    <Wallet size={16} />
                    Connect Wallet
                  </button>
